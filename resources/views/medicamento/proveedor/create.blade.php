        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" align="center" id="inputTitleUsuario"></h4>
                </div>
                ...
                <div class="modal-footer">
                    <div class="col-md-12">
                        ...
                        <button type="button" class="btn btn-primary btn-btnGuardarProveedor" id="btnGuardarProveedor" value="add">Guardar</button>
